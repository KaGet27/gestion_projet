...
public class SensorLatencyDetector extends Detector implements SourceCodeScanner {
    ...
    public static final Issue ISSUE = Issue.create(
            ...
            "A sensor registration with a report latency is better",
